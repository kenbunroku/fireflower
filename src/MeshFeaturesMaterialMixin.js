...
export const MeshFeaturesMaterialMixin = (base) =>
  class extends base {
    get featureTexture() {
    ...
    setFromMeshFeatures(meshFeatures, featureIdOrName) {
      ...
      if (typeof featureIdOrName === "number") {
        ...
        info =
          meshFeatures
            .getFeatureInfo()
            .find((el) => el.label === featureIdOrName) || null;
      }
      ...
      if (info === null) {
        ...
        this._setTextureFeature(
          meshFeatures.textures[info.texture.index],
          info.texture.texCoord,
          info.texture.channels
        );
      } else {
      ...
      if (info !== null) {
        this.nullFeatureId =
          info.nullFeatureId == null ? null : info.nullFeatureId;
      }
    }
...
export const MeshFeaturesMaterial =
  MeshFeaturesMaterialMixin(MeshBasicMaterial);
